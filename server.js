...
const PUBLIC_FILES=new Set(['/index.html','/favicon.ico','/favicon.svg','/apple-touch-icon.png','/og.png','/og-card.svg','/manifest.webmanifest','/guide.html','/privacy.html','/security.html','/styles.css','/comments.css','/a11y.css','/connection.css','/benchmark.css','/improve.css','/postlog.css','/daily.css','/product-v2.css','/core.js','/history.js','/photo-vault.js','/benchmark.js','/benchmark-ui.js','/quality.js','/assemble.js','/improve-ui.js','/postlog.js','/postlog-ui.js','/daily.js','/daily-ui.js','/backup.js','/product-v2.js','/fold-ui.js','/defer-tools.js','/app.js']);

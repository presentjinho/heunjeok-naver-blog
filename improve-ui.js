(function(){
  ...
  function renderQuality(result){
    ...
    const stats=$('qualityStats');if(stats)stats.textContent='문단 '+result.stats.paragraphs+' · 경험문장 '+result.stats.experientialSentences+'/'+result.stats.totalSentences+' · 글자벽 '+result.stats.longWalls+' · 반복 '+(result.stats.duplicates||0);
